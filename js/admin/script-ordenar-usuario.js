$(document).ready(function() { // Esperar a que el DOM esté completamente cargado
    $('#example').DataTable({ // Inicializar DataTable
        ...
        lengthMenu: [5, 10, 15, 20, 25, 50, 100], // Opciones de longitud de página
        columnDefs: [ // Definiciones de columnas
            ...
            { width: "15%", targets: [1] }, // establecer ancho de columna nombre
            { width: "8%", targets: [2] }, // establecer ancho de columna cedula
            { width: "8%", targets: [3] }, // establecer ancho de columna telefono
            { width: "10%", targets: [4] }, // establecer ancho de columna correo
            { width: "5%", targets: [5] }, // establecer ancho de columna contraseña
            { width: "5%", targets: [6] }, // establecer ancho de columna QR
            { width: "7%", targets: [7] }, // establecer ancho de columna fecha de registro
            { width: "8%", targets: [8] }, // establecer ancho de columna rol
            { width: "5%", targets: [9] }, // establecer ancho de columna estado
            { width: "5%", targets: [10] }, // establecer ancho de columna puntos
            { width: "8%", targets: [11] }  // establecer ancho de columna acciones
        ],
