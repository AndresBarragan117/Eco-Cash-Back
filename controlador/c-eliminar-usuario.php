<?php
    if(!empty($_GET["id"])) {
        ...
        if($resultado) {
            ...
            echo "<script>alert('Usuario eliminado correctamente'); location.href='../views/entrar-administrador.php?mensaje=Usuario eliminado correctamente';</script>";
        } else {
            //header('Location: entrar-administrador.php?mensaje=Error al eliminar el usuario');
            echo "<script>alert('Error al eliminar el usuario'); location.href='../views/entrar-administrador.php?mensaje=Error al eliminar el usuario';</script>";
        }
    } else {
